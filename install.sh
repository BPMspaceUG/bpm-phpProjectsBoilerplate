...
# ============================================
# Usage: curl -fsSL https://raw.githubusercontent.com/BPMspaceUG/bpm-phpProjectsBoilerplate/main/install.sh | bash
# Or:    curl -fsSL https://raw.githubusercontent.com/BPMspaceUG/bpm-phpProjectsBoilerplate/main/install.sh | bash -s -- MyProjectName
# ============================================
...
REPO_URL="https://github.com/BPMspaceUG/bpm-phpProjectsBoilerplate"
...
if [ -d ".git" ]; then
    ...
    # Try to get project name from git remote or folder name
...
chmod +x integrate-flightphp-skeleton.sh
