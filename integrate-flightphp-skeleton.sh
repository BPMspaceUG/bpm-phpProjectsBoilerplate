...
echo ""
echo "Next steps:"
echo "  1. Start container: sudo docker compose -f docker-compose.DEV.yml up -d --build"
echo "  2. Install dependencies in container:"
echo "     docker exec -it <container_name> bash -c 'cd /var/www/html && composer install'"
echo ""
